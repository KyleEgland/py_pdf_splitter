...
class MessageBox(object):
    ...
    def __init__(self, msg, b1, b2, frame, t, entry, dropbox, elements,
        ...
        # Single button window for basic user notification (I.e. warning,
        # error, etc.)
        if not b2:
        ...
        # Two button window (I.e. OK and Cancel)
        else:
            ...
            # If entry=True create widget and set focus
            if entry:
                self.entry = tk.Entry(frm_1)
                self.entry.pack()
                self.entry.focus_set()

            # If dropbox=True create widget and set focus
            if dropbox:
            ...
            # If it is specified: call time_out after t seconds
            if t:
...
# Use this function to call up a message box
# I.e. popuphandler.mbox('Error occurred', b2=None, win_title='Error'))
def mbox(msg, b1='OK', b2=None, frame=True, t=False, entry=False,
